    ...
    <div className="idea-text">
      ...
      <div className="idea-block">
        ...
        <p className="idea-block__text">
          ...
          Для Украины это будет первое, своего рода, место для расскрытия
          ...
          минималистически-модернистским дизайном, футуристическим отступлением
          и максимальной отзывчивостью к потребителю. На фоне текущей войны в
          стране и после очевидной победы Украины – это место идеально займет
          свою нишу производства всего выше перечислинного.
        </p>
      </div>
    </div>
  );
