  ...
  return (
    <div className="idea-text">
      <div className="idea-block">
        <h2 className="h2">Basic. Главное в целом:</h2>
        <p>
          ...
          или же поиска информации, развлечения, беззаботного
          времяпрепровождения.
        </p>
        <h3 className="h3">
          Возможности(Ветвь имеет свою производственную деятельность*):
        </h3>
        <p>
          Социальная сеть, ведения фото/видео/текстового микроблогинга.
          *Журналистика.
        </p>
        <p>Онлайн кинотеатр/видеохостинг. *Кино/мульт производство.</p>
        <p>Видеостриминг. *Создание компьютерных игр.</p>
        <p>Имиджборд и анонимный веб-форум.</p>
      </div>
