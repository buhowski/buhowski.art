      ...
      <div className="idea-block">
        ...
        <div className="idea-concept">
          ...
          <p className="idea-block__text">
            ...
            перенаселение планеты, религия, эффект массы, etc.
          </p>
          <p className="idea-block__text">
            ...
            создавать определенные условия для ее появления (смесь
        ...
        <div className="idea-concept">
          ...
          <p className="idea-block__text">
            ...
            безгранично понимающих, свободомыслящих специалистов и начать
            творить новую историю игровой индустрии и украинского кино.
          </p>
          <p className="idea-block__text">
