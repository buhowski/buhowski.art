	...
	const content = (
		<>
			<div className='formField formField--client'>
				...
				<Singleinput
					labelClassName={`formLabel required ${
						invalidInputs.includes('step1ClientEmail') ? 'invalid' : ''
					}`}
					labelText='Email'
					htmlForLabel='step1ClientEmail'
					inputId='step1ClientEmail'
					inputName='step1ClientEmail'
					inputValue={data.step1ClientEmail}
					inputType={`email`}
				/>
