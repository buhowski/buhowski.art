	...
	return (
		<div className='moderna-casa__wrapper'>
			<div className='moderna-casa__navigation'>
				{!isMobile && (<div className='moderna-casa__item'>
				...
				{!isMobile && (<NavLink to={modernaCasaLink} className='moderna-casa__item' target='_blank'>
			...
			{isDesktop ? (<header className='moderna-casa__header'>
				...
				<div className='moderna-casa__header-info'>
					...
					<div className='moderna-casa__header-behance'>
						...
						<a href={modernaCasaLink} target='_blank' className='moderna-casa__header-behance-svg' rel="noreferrer">
							<ReactSVG
								src={behanceIcon}
								wrapper='span'
								style={{
			...
			<div className='moderna-casa__stack'>
				<div className='moderna-casa__stack-titles'>
					{stack.map(stackItem => (
						<div
							key={stackItem.id}
							className={`moderna-casa__stack-title ${stackItem.id === currentStack.id ? 'active-stack-title' : ''
								}`}
			...
			{isDesktop ? (<div className='moderna-casa__content'>
